...
export function render(data) {
  ...
  header.classList.add('p-3', 'text-color', 'text-center');
  header.textContent = 'A LONG TIME AGO IN A GALAXY FAR, FAR AWAY';
  ...
  data.results.forEach((episode, film) => {
    ...
    detailButton.classList.add('btn', 'btn-outline-primary');
